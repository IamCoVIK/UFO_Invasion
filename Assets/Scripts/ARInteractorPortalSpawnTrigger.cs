...
/// </summary>
public class ARInteractorPortalSpawnTrigger : MonoBehaviour
{
    /// <summary>
    ...
    PortalSpawner m_ObjectSpawner;

    /// <summary>
    /// The behavior to use to spawn objects.
    /// </summary>
    public PortalSpawner objectSpawner
    {
        get => m_ObjectSpawner;
...
#else
            m_ObjectSpawner = FindObjectOfType<PortalSpawner>();
#endif
    ...
    void Update()
    {
        ...
        if (m_AttemptSpawn)
        {
            ...
            if (!isPointerOverUI && m_ARInteractor.TryGetCurrentARRaycastHit(out var arRaycastHit))
            {
                ...
                m_ObjectSpawner.TrySpawnPortal(arRaycastHit.pose.position, arPlane.normal);
            }
